...
module.exports = {
    buildRoad: function(creep){
        ...
        if(constructs.length < 3){ // implement if less than 4 roads in queue then build
            ...
            if(roads.length == 0){ // if no roads (i.e 0) then make a construction site for a road !!!!!! WE HAVE TO BUILD AT STAGE 3 OTHERWISE IT INTERFERES WITH THE EXTENSIONS - nvm since only haulers are building this now
